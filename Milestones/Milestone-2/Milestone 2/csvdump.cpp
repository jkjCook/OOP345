...
//Class Task with vector<string>
//Class TaskManager that has a member with vector<Task>
//Trim function that takes off leading and trailing spaces
//Function to get lines from the file
//Function to print the vector takes vector of tasks
//Check that the fields are under 4, check if slots are a number, check if the names aren't numbers
//Function to graph by printing 
/*digraph x {
taskName -> */
//Need validTaskName, validTaskSlots